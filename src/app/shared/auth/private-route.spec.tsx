...
describe('hasAnyAuthority', () => {
  ...
  it('Should return true when authorities is valid and hasAnyAuthorities contains an authority', () => {
    ...
    expect(
      hasAnyAuthority([AUTHORITIES.USER, AUTHORITIES.ADMIN], [AUTHORITIES.USER, AUTHORITIES.ADMIN])
    ).toEqual(true)
    expect(hasAnyAuthority([AUTHORITIES.USER, AUTHORITIES.ADMIN], [AUTHORITIES.USER, 'ROLEADMIN']))
      .toEqual(true)
    expect(hasAnyAuthority([AUTHORITIES.USER, AUTHORITIES.ADMIN], [AUTHORITIES.ADMIN])).toEqual(
      true
    )
  })
  ...
  it('Should return false when authorities is valid and hasAnyAuthorities does not contain an authority', () => {
    ...
    expect(hasAnyAuthority([AUTHORITIES.USER, AUTHORITIES.ADMIN], ['ROLEUSER', 'ROLEADMIN']))
      .toEqual(false)
  })
})
