...
import { getEntity, deleteEntity } from './bed.reducer';
...
export const BedDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gestionhebergementApp.bed.delete.question">Êtes-vous sûr de vouloir supprimer cet lit ?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Retour
        </Button>
        <Button id="jhi-confirm-delete-bed" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
