...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './bedroom-kind.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IBedroomKind, defaultValue } from 'app/shared/model/bedroom-kind.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEDROOMKIND_LIST actions', async () => {
    ...
    it('dispatches FETCH_BEDROOMKIND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BEDROOMKIND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BEDROOMKIND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BEDROOMKIND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BEDROOMKIND actions', async () => {
      const expectedActions = [
        {
