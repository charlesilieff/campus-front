...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset,
  updateEntity } from './meal.reducer'
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_MEAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEAL actions', async () => {
      const expectedActions = [
        {
