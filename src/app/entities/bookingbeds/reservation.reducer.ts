...
import { IBookingBeds, defaultValue } from 'app/shared/model/bookingBeds.model';
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IReservation, thunkAPI) => {
    const result = await axios.put<IBookingBeds>(`${apiUrlBookingBeds}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
