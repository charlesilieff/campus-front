        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField label="Réservation payé ?" id="reservation-isPaid" name="isPaid" data-cy="isPaid" check type="checkbox" />
              <ValidatedField
              ...
              <ValidatedField label="Lits" id="reservation-bed" data-cy="bed" type="select" multiple name="beds">
                <option value="" key="0" />
                {beds
              ...
              <ValidatedField id="reservation-customer" name="customerId" data-cy="customer" label="Client" type="select">
                <option value="" key="0" />
                {customers
