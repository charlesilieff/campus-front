...
export const ReservationLunchOnly = (props: RouteComponentProps<{ url: string }>) => {
  ...
  const getReservations = async (startDate: Dayjs) => {
    const requestUrl = `${apiUrlReservations}/${startDate.format('YYYY-MM-DD')}?cacheBuster=${new Date().getTime()}`;
  ...
  return (
    <div>
      ...
      <div className="table-responsive">
        <input className="inline-block" id="date" name="date" data-cy="date" type="date" onChange={newDate}></input>
