...
export const RGPD = () => (
  <VStack alignItems={'flex-start'}>
    ...
    <p>
      <b>Client :</b>{' '}
      tout professionnel ou personne physique capable au sens des articles 1123 et suivants du Code
      civil, ou personne morale, qui visite le Site objet des présentes conditions générales.<br>
      </br>
      <b>Prestations et Services :</b>{' '}
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>{' '}
      met à disposition des Clients :
    </p>
    <p>
      <b>Contenu :</b>{' '}
      Ensemble des éléments constituants l’information présente sur le Site, notamment textes –
      images – vidéos.
    </p>
    <p>
      <b>Informations clients :</b>{' '}
      Ci après dénommé « Information (s) » qui correspondent à l’ensemble des données personnelles
      susceptibles d’être détenues par{' '}
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>{' '}
      pour la gestion de votre compte, de la gestion de la relation client et à des fins d’analyses
      et de statistiques.
    </p>
    <p>
    ...
    <p>
      ...
      « Les informations qui permettent, sous quelque forme que ce soit, directement ou non,
      l&apos;identification des personnes physiques auxquelles elles s&apos;appliquent » (article 4
    ...
    <p>
      ...
      : Campus de la Transition – Campus de la Transition Domaine de Forges 2 rue de Salins 77130
      Forges
      <br />
    ...
    <p>
      ...
      décrites. Ces conditions d’utilisation sont susceptibles d’être modifiées ou complétées à tout
      moment, les utilisateurs du site{' '}
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>{' '}
    ...
    <p>
      ...
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>, qui s’efforcera alors de communiquer préalablement aux utilisateurs les dates et heures
    ...
    <p>
      ...
      des oublis, des inexactitudes et des carences dans la mise à jour, qu’elles soient de son fait
    ...
    <p>
      ...
      est hébergé chez un prestataire sur le territoire de l’Union Européenne conformément aux
      dispositions du Règlement Général sur la Protection des Données (RGPD : n° 2016-679)
    </p>
    <p>
    ...
    <p>
      ...
      Internet, des lignes téléphoniques ou du matériel informatique et de téléphonie lié notamment
    ...
    <p>
      ...
      est propriétaire des droits de propriété intellectuelle et détient les droits d’usage sur tous
      les éléments accessibles sur le site internet, notamment les textes, images, graphismes,
      logos, vidéos, icônes et sons. Toute reproduction, représentation, modification, publication,
    ...
    <p>
      ...
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>, et résultant soit de l’utilisation d’un matériel ne répondant pas aux spécifications
    ...
    <p>
      ...
      ne pourra également être tenu responsable des dommages indirects (tels par exemple qu’une
      perte de marché ou perte d’une chance) consécutifs à l’utilisation du site{' '}
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>. Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont
    ...
    <p>
      ...
      Personnelles est : Campus de la Transition.{' '}
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>est représenté par Clément Puech, son représentant légal
    </p>
    <p>
      ...
      Données Personnelles au regard des finalités pour lesquelles{' '}
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>{' '}
      les traite.
    ...
    <p>
      ...
      ne commercialise pas vos données personnelles qui sont donc uniquement utilisées par nécessité
    ...
    <p>
      ...
      par la loi, notamment en matière de conservation ou d’archivage des documents. Enfin, les
      Utilisateurs de{' '}
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>{' '}
    ...
    <p>
      ...
      s’interdit de traiter, héberger ou transférer les Informations collectées sur ses Clients vers
      un pays situé en dehors de l’Union européenne ou reconnu comme « non adéquat » par la
      Commission européenne sans en informer préalablement le client. Pour autant,{' '}
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>{' '}
      reste libre du choix de ses sous-traitants techniques et commerciaux à la condition qu’il
    ...
    <p>
      ...
      Informations et notamment qu’elles ne soient pas communiquées à des personnes non autorisées.
      Cependant, si un incident impactant l’intégrité ou la confidentialité des Informations du
      Client est portée à la connaissance de{' '}
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>, celle-ci devra dans les meilleurs délais informer le Client et lui communiquer les
    ...
    <p>
      ...
      obligations légales, q&apos;elles se situent au niveau national ou européen. Nous nous
      engageons à informer pleinement nos clients de toutes les questions relevant de la sécurité de
      leur compte et à leur fournir toutes les informations nécessaires pour les aider à respecter
    ...
    <p>
      ...
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>prend toutes les mesures raisonnables visant à les protéger contre toute perte,
    ...
    <p>
      ...
      contient un certain nombre de liens hypertextes vers d’autres sites, mis en place avec
      l’autorisation de{' '}
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>. Cependant,{' '}
    ...
    <p>
      ...
      est susceptible de traiter les informations de l’Utilisateur concernant sa visite du Site,
      telles que les pages consultées, les recherches effectuées. Ces informations permettent à{' '}
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>{' '}
    ...
    <p>
      ...
      ou l’un de ses prestataires ne peut pas reconnaître, à des fins de compatibilité technique, le
      type de navigateur utilisé par le terminal, les paramètres de langue et d’affichage ou le pays
    ...
    <p>
      ...
      décline toute responsabilité pour les conséquences liées au fonctionnement dégradé du Site et
      des services éventuellement proposés par{' '}
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>, résultant (i) du refus de Cookies par l’Utilisateur (ii) de l’impossibilité pour{' '}
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>{' '}
    ...
    <p>
      ...
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>, Twitter, Facebook, Linkedin et Google Plus peuvent également déposer des cookies sur vos
    ...
    <p>
      ...
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>. À tout moment, l’Utilisateur peut néanmoins revenir sur son consentement à ce que{' '}
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>{' '}
    ...
    <p>
      ...
      peut employer occasionnellement des balises Internet (également appelées « tags », ou balises
      d’action, GIF à un pixel, GIF transparents, GIF invisibles et GIF un à un) et les déployer par
      l’intermédiaire d’un partenaire spécialiste d’analyses Web susceptible de se trouver (et donc
      de stocker les informations correspondantes, y compris l’adresse IP de l’Utilisateur) dans un
      pays étranger.
    </p>
    <p>
    ...
    <p>
      ...
      le nombre de fois où une page est ouverte et les informations consultées), ainsi que
    ...
    <p>
      ...
      <a href="https://hebergement.campus-transition.org">
        https://hebergement.campus-transition.org
      </a>, et fournir d’autres services relatifs à l’utilisation de celui-ci et d’Internet.
    </p>
    <p></p>
