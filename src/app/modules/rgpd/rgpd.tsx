  ...
  return (
    <Row>
      ...
      <Col md="9">
        ...
        <p>
          <b>Client :</b>{' '}
          tout professionnel ou personne physique capable au sens des articles 1123 et suivants du
          Code civil, ou personne morale, qui visite le Site objet des présentes conditions
          générales.<br></br>
        ...
        <p>
          ...
          Ci après dénommé « Information (s) » qui correspondent à l’ensemble des données
          personnelles susceptibles d’être détenues par{' '}
          <a href="https://hebergement.campus-transition.org">
            https://hebergement.campus-transition.org
          </a>{' '}
          pour la gestion de votre compte, de la gestion de la relation client et à des fins
        ...
        <p>
          ...
          : Campus de la Transition – Campus de la Transition Domaine de Forges 2 rue de Salins
          77130 Forges
          <br />
        ...
        <p>
          ...
          décrites. Ces conditions d’utilisation sont susceptibles d’être modifiées ou complétées à
        ...
        <p>
          ...
          <a href="https://hebergement.campus-transition.org">
            https://hebergement.campus-transition.org
          </a>, qui s’efforcera alors de communiquer préalablement aux utilisateurs les dates et
        ...
        <p>
          ...
          Internet, des lignes téléphoniques ou du matériel informatique et de téléphonie lié
        ...
        <p>
          ...
          tous les éléments accessibles sur le site internet, notamment les textes, images,
          graphismes, logos, vidéos, icônes et sons. Toute reproduction, représentation,
        ...
        <p>
          ...
          <a href="https://hebergement.campus-transition.org">
            https://hebergement.campus-transition.org
          </a>. Des espaces interactifs (possibilité de poser des questions dans l’espace contact)
        ...
        <p>
          ...
          notamment au Client d’établir les finalités de ses traitements de données, de fournir à
          ses prospects et clients, à partir de la collecte de leurs consentements, une information
        ...
        <ul>
          <li>
            ...
            jour, de complétude des données des Utilisateurs droit de verrouillage ou d’effacement
            des données des Utilisateurs à caractère personnel (article 17 du RGPD), lorsqu’elles
        ...
        <p>
          ...
          tiennent compte de nos obligations légales, q&apos;elles se situent au niveau national ou
          européen. Nous nous engageons à informer pleinement nos clients de toutes les questions
          relevant de la sécurité de leur compte et à leur fournir toutes les informations
          nécessaires pour les aider à respecter leurs propres obligations réglementaires en matière
          de reporting.
        </p>
        <p>
        ...
        <p>
          ...
          d’enregistrer ou de consulter les Cookies nécessaires à leur fonctionnement du fait du
          choix de l’Utilisateur. Pour la gestion des Cookies et des choix de l’Utilisateur, la
        ...
        <p>
          ...
          et Google Plus figurant sur le Site de{' '}
          <a href="https://hebergement.campus-transition.org">
            https://hebergement.campus-transition.org
          </a>{' '}
          ...
          <a href="https://hebergement.campus-transition.org">
            https://hebergement.campus-transition.org
          </a>, Twitter, Facebook, Linkedin et Google Plus peuvent également déposer des cookies sur
        ...
        <p>
          ...
          peut employer occasionnellement des balises Internet (également appelées « tags », ou
          balises d’action, GIF à un pixel, GIF transparents, GIF invisibles et GIF un à un) et les
          déployer par l’intermédiaire d’un partenaire spécialiste d’analyses Web susceptible de se
