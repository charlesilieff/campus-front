  ...
  <Row>
    ...
    <Col md="9">
      ...
      <p>
        ...
        l&apos;identification des personnes physiques auxquelles elles s&apos;appliquent » (article
      ...
      <p>
        ...
        des oublis, des inexactitudes et des carences dans la mise à jour, qu’elles soient de son
      ...
      <ul>
        <li>
          ...
          jour, de complétude des données des Utilisateurs droit de verrouillage ou d’effacement des
      ...
      <p>
        ...
        prendre les mesures appropriées. Nos procédures de notification d’incident tiennent compte
        de nos obligations légales, q&apos;elles se situent au niveau national ou européen. Nous
        nous engageons à informer pleinement nos clients de toutes les questions relevant de la
        sécurité de leur compte et à leur fournir toutes les informations nécessaires pour les aider
        à respecter leurs propres obligations réglementaires en matière de reporting.
      </p>
      <p>
      ...
      <p>
        ...
        le type de navigateur utilisé par le terminal, les paramètres de langue et d’affichage ou le
      ...
      <p>
        ...
        pourra en outre faire appel aux services de prestataires externes pour l’aider à recueillir
