        ...
        <Col md="8">
          {loading ? (
            ...
            <div>
              <h4>
                <p>
                  Votre demande de réservation a bien été envoyée, vous allez recevoir une confirmation sous trois jours et un email pour
                  pouvoir modifier/annuler votre demande.
                </p>{' '}
                <p>
            ...
            <FormProvider {...form}>
              <form onSubmit={form.handleSubmit(saveEntity)}>
                ...
                <CustomValidatedField
                  ...
                  type="textarea"
                  registerOptions={{
                    maxLength: { value: 400, message: 'Le commentaire ne peut pas faire plus de 400 caractéres.' },
                  }}
                />
                <CustomValidatedField
