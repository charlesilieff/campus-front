...
export const Day = ({ positionX, date, index, isButtonPressed: isButtonPressed }: IProps) => {
  ...
  useEffect(() => {
    const mealsToCookFromDb: IMealsNumber = {
      lunchtime: { specialDiet: mealsContext[index]?.specialLunchToCook, classicDiet: mealsContext[index]?.regularLunchToCook },
      dinner: { specialDiet: mealsContext[index]?.specialDinnerToCook, classicDiet: mealsContext[index]?.regularDinnerToCook },
    ...
    const mealsReferentialFromDb: IMealsNumber = {
      lunchtime: { specialDiet: mealsContext[index]?.specialLunch, classicDiet: mealsContext[index]?.regularLunch },
      dinner: { specialDiet: mealsContext[index]?.specialDinner, classicDiet: mealsContext[index]?.regularDinner },
      comment: mealsContext[index]?.comment,
    };
    ...
    const theNewMealsNumber = {
      lunchtime: {
        specialDiet:
          mealsToCookFromDb.lunchtime.specialDiet - mealsReferentialFromDb.lunchtime.specialDiet === 0
            ? mealsReferentialFromDb.lunchtime.specialDiet
            : mealsToCookFromDb.lunchtime.specialDiet,

        classicDiet:
          mealsToCookFromDb.lunchtime.classicDiet - mealsReferentialFromDb.lunchtime.classicDiet === 0
   ...
   */
  const counterNumber = (plusMinus: 'plus' | 'minus', time: 'lunchtime' | 'dinner', diet: 'specialDiet' | 'classicDiet') => {
    const newMealsNumber: IMealsNumber = {
      lunchtime: { specialDiet: mealsNumber.lunchtime.specialDiet, classicDiet: mealsNumber.lunchtime.classicDiet },
      dinner: { specialDiet: mealsNumber.dinner.specialDiet, classicDiet: mealsNumber.dinner.classicDiet },
  ...
  return (
    <>
      ...
      >
        <Button onClick={() => counterNumber('plus', 'lunchtime', 'classicDiet')} color="none" className="kitchenBtn">
        ...
        <Button onClick={() => counterNumber('minus', 'lunchtime', 'classicDiet')} color="none" className="kitchenBtn">
      ...
      >
        <Button onClick={() => counterNumber('plus', 'lunchtime', 'specialDiet')} className="bouton" color="none">
          <FontAwesomeIcon icon="plus-circle" size="1x" color="green" />
        </Button>
        <div
          style={
        ...
        <Button onClick={() => counterNumber('minus', 'lunchtime', 'specialDiet')} color="none" className="kitchenBtn">
          <FontAwesomeIcon icon="minus-circle" size="1x" color="red" />
        </Button>
      </div>
      ...
      >
        <Button onClick={() => counterNumber('plus', 'dinner', 'classicDiet')} color="none" className="kitchenBtn">
          <FontAwesomeIcon icon="plus-circle" size="1x" color="green" />
        </Button>
        <div
          style={
        ...
        <Button onClick={() => counterNumber('minus', 'dinner', 'classicDiet')} color="none" className="kitchenBtn">
          <FontAwesomeIcon icon="minus-circle" size="1x" color="red" />
        </Button>
      </div>
      ...
      >
        <Button onClick={() => counterNumber('plus', 'dinner', 'specialDiet')} color="none" className="kitchenBtn">
          <FontAwesomeIcon icon="plus-circle" size="1x" color="green" />
        </Button>
        <div
          style={
        ...
        <Button onClick={() => counterNumber('minus', 'dinner', 'specialDiet')} color="none" className="kitchenBtn">
          <FontAwesomeIcon icon="minus-circle" size="1x" color="red" />
        </Button>
      </div>

      {commentPopupFunction(modal, toggle, date, submitModalPopup, commentPopup, changeCommentPopup)}
    </>
  );
};
      ...
      <ModalBody>
        <div>
          <form onSubmit={submitModalPopup}>
            <textarea cols={35} rows={8} maxLength={400} value={commentPopup} onChange={e => changeCommentPopup(e.target.value)} />
            <br />
