  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gestionhebergementApp.room.home.createOrEditLabel" data-cy="RoomCreateUpdateHeading">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              <ValidatedField
                ...
                validate={{
                  ...
                  minLength: { value: 1, message: 'Le nom ne doit pas comporter moins de 1 caractères.' },
                  maxLength: { value: 20, message: 'Le nom ne doit pas comporter plus de 20 caractères.' },
                }}
              />
              <ValidatedField
                label="Commentaire"
                ...
                type="text"
                validate={{
                  maxLength: { value: 400, message: 'Le commentaire ne doit pas comporter plus de 400 caractères.' },
                }}
              />
              <ValidatedField id="room-place" name="placeId" data-cy="place" label="Lieu" type="select">
                <option value="" key="0" />
                {places
              ...
              <ValidatedField id="room-bedroomKind" name="bedroomKindId" data-cy="bedroomKind" label="Type de chambres" type="select">
                <option value="" key="0" />
                {bedroomKinds
