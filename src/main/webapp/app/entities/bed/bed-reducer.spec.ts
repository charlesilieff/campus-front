...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bed.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IBed, defaultValue } from 'app/shared/model/bed.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BED_LIST actions', async () => {
    ...
    it('dispatches FETCH_BED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BED actions', async () => {
      const expectedActions = [
        {
