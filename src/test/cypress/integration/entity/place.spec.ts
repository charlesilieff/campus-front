...
describe('Place e2e test', () => {
  ...
  it('should create an instance of Place', () => {
    ...
    cy.get(`[data-cy="name"]`).type('Administrateur markets').should('have.value', 'Administrateur markets');

    cy.get(`[data-cy="comment"]`).type('Fantastic payment Generic').should('have.value', 'Fantastic payment Generic');
