import { emailSettingsSelector, firstNameSettingsSelector, lastNameSettingsSelector,
  submitSettingsSelector } from '../../support/commands'
...
describe('/account/settings', () => {
  ...
  it("should be able to change 'user' firstname settings", () => {
    ...
    cy.wait('@settingsSave').then(({ request, response }) =>
